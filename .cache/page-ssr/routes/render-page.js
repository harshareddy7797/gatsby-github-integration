...
var _react = _interopRequireDefault(__webpack_require__(688));
...
var getGlobalPathPrefix = function getGlobalPathPrefix() {
  return  false ? 0 : "/gatsby-github-integration";
};
...
var React = _interopRequireWildcard(__webpack_require__(688));
...
var _react = __webpack_require__(688);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(688);
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/gatsby-github-integration"))// Remove any hashfragment
...
// EXTERNAL MODULE: external "C:\\Users\\002HB0744\\Desktop\\gatsby-github-pages\\node_modules\\react\\index.js"
var external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_ = __webpack_require__(688);
var external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_);
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet(`${"/gatsby-github-integration"}/page-data/sq/d/${staticQueryHash}.json`).then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error(`We couldn't load "${"/gatsby-github-integration"}/page-data/sq/d/${staticQueryHash}.json"`);});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(({staticQueryHash,jsonPayload})=>{staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromise,staticQueryBatchPromise]).then(([pageResources,staticQueryResults])=>{let payload;if(pageResources){payload={...pageResources,staticQueryResults};finalResult.payload=payload;emitter.emit(`onPostLoadPageResources`,{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
const prefetchPathname=loader.enqueue;const StaticQueryContext=/*#__PURE__*/external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createContext({});function StaticQueryDataRenderer({staticQueryData,data,query,render}){const finalData=data?data.data:staticQueryData[query]&&staticQueryData[query].data;return/*#__PURE__*/external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement((external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default()).Fragment,null,finalData&&render(finalData),!finalData&&/*#__PURE__*/external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement("div",null,"Loading (StaticQuery)"));}const StaticQuery=props=>{const{data,query,render,children}=props;return/*#__PURE__*/external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(StaticQueryContext.Consumer,null,staticQueryData=>/*#__PURE__*/external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(StaticQueryDataRenderer,{data:data,query:query,render:render||children,staticQueryData:staticQueryData}));};const useStaticQuery=query=>{var _context$query;if(typeof (external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default()).useContext!==`function`&&"production"===`development`){}const context=external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().useContext(StaticQueryContext);// query is a stringified number like `3303882` when wrapped with graphql, If a user forgets
...
var createNamedContext = function createNamedContext(name, defaultValue) {
  var Ctx = (0,external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_.createContext)(defaultValue);
...
var Location = function Location(_ref) {
  ...
  return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(
    LocationContext.Consumer,
    null,
    function (context) {
      return context ? children(context) : external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(
        LocationProvider,
        null,
        children
      );
...
}((external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default()).Component);
    ...
    function (baseContext) {
      return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(
        ...
        function (locationContext) {
          return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(RouterImpl, es_extends({}, baseContext, locationContext, props));
        }
      );
    }
  );
...
var RouterImpl = function (_React$PureComponent) {
  ...
  RouterImpl.prototype.render = function render() {
    ...
    var routes = external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().Children.toArray(children).reduce(function (array, child) {
    ...
    if (match) {
      ...
      var clone = external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().cloneElement(element, props, element.props.children ? external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(
        Router,
      ...
      return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(
        ...
        external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(
          FocusWrapper,
          wrapperProps,
          clone
        )
  ...
  return RouterImpl;
}((external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default()).PureComponent);
...
var FocusHandler = function FocusHandler(_ref3) {
  ...
  return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(
    ...
    function (requestFocus) {
      return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(FocusHandlerImpl, es_extends({}, domProps, {
        component: component,
...
////////////////////////////////////////////////////////////////////////////////
var forwardRef = (external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default()).forwardRef;
    ...
    function (_ref5) {
      ...
      return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(
        ...
        function (_ref6) {
          ...
          return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement("a", es_extends({
            ref: ref || innerRef,
  ...
  return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(
    ...
    function (_ref7) {
      ...
      return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(
        ...
        null,
        function (locationContext) {
          return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().createElement(RedirectImpl, es_extends({}, locationContext, { baseuri: baseuri }, props));
        }
      );
    }
  );
...
var useLocation = function useLocation() {
  var context = (0,external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_.useContext)(LocationContext);
...
var useNavigate = function useNavigate() {
  var context = (0,external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_.useContext)(BaseContext);
...
var createRoute = function createRoute(basepath) {
  return function (element) {
    ...
    if (element.type === (external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default()).Fragment && element.props.children) {
      return external_C_Users_002HB0744_Desktop_gatsby_github_pages_node_modules_react_index_js_default().Children.map(element.props.children, createRoute(basepath));
    }
...
"use strict";
module.exports = require("C:\\Users\\002HB0744\\Desktop\\gatsby-github-pages\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Users\\002HB0744\\Desktop\\gatsby-github-pages\\node_modules\\react-dom\\server.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-b001ed1f2fd6e7ad8ae1.js"],"app":["/app-19b1ced6cdae78b331c3.js"]}');
...
if(!isRedirect(e))throw e;}}apiRunner(`onRenderBody`,{setHeadComponents,setHtmlAttributes,setBodyAttributes,setPreBodyComponents,setPostBodyComponents,setBodyProps,pathname:pagePath,loadPageDataSync,bodyHtml,scripts,styles,pathPrefix:"/gatsby-github-integration"});reversedScripts.forEach(script=>{// Add preload/prefetch <link>s magic comments
if(script.shouldGenerateLink){headComponents.push(/*#__PURE__*/React.createElement("link",{as:"script",rel:script.rel,key:script.name,href:`${"/gatsby-github-integration"}/${script.name}`}));}});reversedStyles.forEach(style=>{// Add <link>s for styles that should be prefetched
// otherwise, inline as a <style> tag
if(style.rel===`prefetch`){headComponents.push(/*#__PURE__*/React.createElement("link",{as:"style",rel:style.rel,key:style.name,href:`${"/gatsby-github-integration"}/${style.name}`}));}else{headComponents.unshift(/*#__PURE__*/React.createElement("style",{"data-href":`${"/gatsby-github-integration"}/${style.name}`,"data-identity":`gatsby-global-css`,dangerouslySetInnerHTML:{__html:style.content}}));}});// Add page metadata for the current page
